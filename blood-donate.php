...
<script type="text/javascript">
  ...
  $.ajax({
    url:"https://api.data.gov.in/resource/fced6df9-a360-4e08-8ca0-f283fc74ce15?api-key=579b464db66ec23bdd0000016eb95066326649877300f6063b2b8d14&format=json&offset=0&limit=2000",
    type:"GET",
    dataType:"JSON",
    ...
    var newArray = blood_data.records.filter(function (el) {
      ...
      return el.__state === 'Chhattisgarh';
