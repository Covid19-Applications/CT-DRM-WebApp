...
form #logout{
 ...
 <div class="main-content" style="background-color: #C58D20;" >
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                                ...
                                <div class="overview-item overview-item--c5">
                                    <div class="overview__inner">
                                        <div class="overview-box clearfix">
                                            ...
                                            <div class="text">
                                                <span style="font-size: 17px;">Chhattisgarh Confirmed Cases</span>
                                ...
                                <div class="overview-item overview-item--recovered">
                                    <div class="overview__inner">
                                        <div class="overview-box clearfix">
                                            ...
                                            <div class="text">
                                                <span style="font-size: 17px;">Chhattisgarh Recovered Cases</span>
                                ...
                                <div class="overview-item overview-item--death">
                                    <div class="overview__inner">
                                        <div class="overview-box clearfix">
                                            ...
                                            <div class="text">
                                                <span style="font-size: 17px;">Chhattisgarh Death Cases</span>
                                                <h2 id="StateDeath"></h2>
                                            </div>
                                            <div class="progress">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <h2 class="title-1 m-b-25">Covid19 Cases In Chhattisgarh</h2>
                            ...
                            <div class="col-lg-3">
                               ...
                               <div class="col-lg-12">
                                <h2 class="title-1 m-b-25">Covid19 Test Cases In Chhattisgarh</h2>
                                <div class="table-responsive table--no-card m-b-40">
                                     ...
                                     <div class="au-card chart-percent-card" style="height: 580px;" id="testing">
                                        <div class="au-card-inner">
                                            ...
                                            <div class="row no-gutters">
                                                ...
                                                <div class="col-lg-12">
                                                    <iframe src="https://www.google.co.in/maps/d/embed?mid=1enB3gDn1CDlvsKO6ibHj4Jz4CGdc7b5A" width="100%" height="380"></iframe>
                                                </div>
                                            </div>    
                                        </div>    
                                     </div>
          ...
          datasets: [
            {
              ...
              data: [Greenlength,Redlength,Orangelength],
              backgroundColor: [
                'green',
                'orange',
                'red'
